...
A [letter of attestation](https://proton.me/blog/security-audit-all-proton-apps) was provided for Proton Mail's apps in November 2021 by [Securitum](https://research.securitum.com).
...
=== "Web"
    ...
    - [x] Disable **Collect usage dignostics**
    - [x] Disable **Send crash reports**

=== "Android"

    From your inbox, select :material-menu: → :gear: **Settings**.

    - [x] Disable **Anonymous telemetry**
    - [x] DIsable **Anonymous crash reports**
